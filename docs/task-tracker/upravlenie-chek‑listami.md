...
![Панель инструментов](/img/task-tracker/bar-checklist.png)
...
![Восстановление чек-листа](/img/task-tracker/recreate-checklist.png)
...
2. В списке чек-листов раздела найдите нужный чек-лист, после нажмите на значок **«Создать задачу»**.<br />
   ...
   ![Создание задачи на основе чек-листа](/img/task-tracker/create-task-signal.png)
